 ...
 * extending this class and overloading the {@link #view} method.
 * <p>
...
/** Minimal constructor. */
	public GraphView(String inMenuText) {
		menuText = inMenuText;
	}

/** Trivial constructor. */
	public GraphView(int inAccelerator, String inMenuText) {
		acceleratorKey = inAccelerator;
		menuText = inMenuText;
	}

/** Trivial constructor. */
	public GraphView(int inAccelerator, String inMenuText, int inMnemonic) {
		acceleratorKey = inAccelerator;
		menuText = inMenuText;
...
/** Overwrite this with the view change to the graph. */
