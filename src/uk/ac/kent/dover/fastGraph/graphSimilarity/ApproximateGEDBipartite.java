 ...
 * and both seem to return the same results on random diagrams,
...
//				System.out.println("MISMATCH "+i+" : "+ret[i]);
			}
	 ...
	 */
	public ApproximateGEDBipartite(boolean directed, boolean nodeLabels, HashMap<Integer,Double> editCosts, long nodeSwapTimeLimit, int nodeSwapAttempts, long randomSeed) throws FastGraphException {
		super();
		this.editCosts = editCosts;
