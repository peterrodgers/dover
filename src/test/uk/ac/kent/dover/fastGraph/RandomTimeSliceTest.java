...
public class RandomTimeSliceTest {
	...
	public void test001() throws IOException {
		...
		FastGraph g2 = g.randomTimeSeriesFactory(0.2, 0.2, 2, 2, false, false);
	...
	public void test002() throws IOException {
		...
		FastGraph g2 = g.randomTimeSeriesFactory(0.2, 0.2, 2, 2, false, true);
	...
	public void test003() throws IOException {
		FastGraph g = FastGraph.jsonStringGraphFactory(TestRunner.get5Node5Edge(),false);
		FastGraph g2 = g.randomTimeSeriesFactory(0.2, 0.2, 2, 2, false, true);
		g2 = g2.randomTimeSeriesFactory(0.2, 0.2, 2, 2, false, true);
